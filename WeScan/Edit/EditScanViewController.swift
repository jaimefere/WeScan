...
final class EditScanViewController: UIViewController {
    ...
    private lazy var nextButton: UIBarButtonItem = {
        let title = NSLocalizedString("wescan.edit.button.done", bundle: .module, comment: "A generic done button")
    ...
    private lazy var cancelButton: UIBarButtonItem = {
        let title = NSLocalizedString("wescan.scanning.cancel", bundle: .module, comment: "A generic cancel button")
    ...
    override public func viewDidLoad() {
        ...
        setupViews()
        setupConstraints()
        title = NSLocalizedString("wescan.edit.title", bundle: .module, comment: "The title of the EditScanViewController")
